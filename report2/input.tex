...
Le module propose des macros de création directe encapsulant des structures \texttt{entry\_config} pré-remplies pour des cas d'usage courants.
...
\paragraph{Macros associées :}
Des presets de configuration facilitent l'initialisation des plages de valeurs pour les boutons numériques.
