...
Le module bénéficie de macros de configuration rapide comme \texttt{BOX\_H(sp)} et \texttt{BOX\_V(sp)}. Ces macros instancient des structures \texttt{box\_config} temporaires, réduisant la verbosité du code utilisateur.
