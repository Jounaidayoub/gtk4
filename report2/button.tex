...
Les macros de variantes de thèmes permettent de s'abstraire des chaînes de caractères brutes. Elles garantissent l'utilisation de noms de classes CSS cohérents avec la logique interne du module, qui traduit ces alias en classes GTK réelles (ex: \texttt{btn-primary}).
