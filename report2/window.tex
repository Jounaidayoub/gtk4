...
Le module définit des macros pour centraliser les dimensions standards et proposer une création rapide. La macro \texttt{CREATE\_SIMPLE\_WINDOW} instancie une structure \texttt{window\_config} par défaut, tandis que les constantes \texttt{WIN\_SIZE\_*} assurent une cohérence dimensionnelle.
