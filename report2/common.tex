...
L'implémentation repose sur des macros de substitution pour les types énumérés de GTK. Cette approche permet de découpler légèrement le code utilisateur des constantes internes de GTK tout en conservant une performance maximale. Les macros de marges garantissent une cohérence visuelle dans l'ensemble de l'application.
